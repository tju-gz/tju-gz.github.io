...
I have published full research papers on <span style="display: inline-block; background-color: 	#208817; color: white; padding: 1.5px 6px; border-radius: 3px; font-weight: bold; line-height: 100%;">ALL CCF A conferences</span> in computer networks, including <span style="display: inline-block; background-color: #172088; color: white; padding: 1.5px 6px; border-radius: 3px; font-weight: bold; line-height: 100%;">ACM SIGCOMM</span>, <span style="display: inline-block; background-color: #172088; color: white; padding: 1.5px 6px; border-radius: 3px; font-weight: bold; line-height: 100%;">ACM MobiCom</span>, <span style="display: inline-block; background-color: #172088; color: white; padding: 1.5px 6px; border-radius: 3px; font-weight: bold; line-height: 100%;">USENIX NSDI</span>, and <span style="display: inline-block; background-color: #172088; color: white; padding: 1.5px 6px; border-radius: 3px; font-weight: bold; line-height: 100%;">IEEE INFOCOM</span>. My work has been awarded the <span style="display: inline-block; background-color: #ce1e27; color: white; padding: 1.5px 6px; border-radius: 3px; font-weight: bold; line-height: 100%;">Best Demo Award Runner-Up</span> at ACM MobiCom 2022. 
